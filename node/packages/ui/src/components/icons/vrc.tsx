...
/*
 * Contains code from VRC Icons by kurone-kito.
 * Original source: https://github.com/kurone-kito/launchpad-icons/blob/18a88b4cea3c7555719746f93e7898d1d1d51e9e/Packages/black.kit.launchpadicons/Runtime/VRC.svg?plain=1#L15
 * Licensed under https://github.com/kurone-kito/launchpad-icons?tab=License-1-ov-file
 *
 * Modified by ichi-h in 2026.
 */
export const VRCIcon = ({ color = "mono.900", ...props }: Props) => {
  return (
    <svg
