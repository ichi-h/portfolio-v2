...
特に技術的な側面から発生する問題や、技術によって直接解決できる問題は積極的に企画・提案・実行を行い、プロダクトの改善から生産性の向上等に寄与しました。

- 金融機関向けSaaSプロダクト群の要求定義・要件定義・システムデザイン・開発・保守・運用
...
- toC向け保険比較ランキングサイトおよび保険相談LPページの立ち上げ・改善にまつわる開発・保守・運用
- など
...
- 金融機関向けSaaSプロダクトをVue→Reactへ移行する大規模マイグレーションをエラー0で完遂
